...
const GALLERY_IMAGES: GalleryImage[] = [
  {
    id: 1,
    src: 'https://res.cloudinary.com/dci7rpsws/image/upload/v1758570346/ru3mz2o1k7vmjmqipylb_lgyulb.webp',
    alt: 'Mesa Sucupira - Vista principal',
  },
  {
    id: 2,
    src: 'https://res.cloudinary.com/dci7rpsws/image/upload/v1758570353/zvi3v1icnmymmlpjphn9_zhffma.webp',
    alt: 'Mesa Sucupira - Detalhe lateral',
  },
  {
    id: 3,
    src: 'https://res.cloudinary.com/dci7rpsws/image/upload/v1758570351/tzb941yy75wtvyexij7k_ectbxu.webp',
    alt: 'Mesa Sucupira - Detalhe mármore',
  },
  {
    id: 4,
    src: 'https://res.cloudinary.com/dci7rpsws/image/upload/v1758570349/s3swqkyffbn4be7xhivp_iaqump.webp',
    alt: 'Mesa Sucupira - Vista completa',
  },
  {
    id: 5,
    src: 'https://res.cloudinary.com/dci7rpsws/image/upload/v1758570347/rxf6g9wfbmzf4l4acuxn_hxpok7.webp',
    alt: 'Mesa Sucupira - Acabamento',
  },
  {
    id: 6,
    src: 'https://res.cloudinary.com/dci7rpsws/image/upload/f_auto,q_auto/v1756751841/customfurniture_yp3kib.png',
    alt: 'Mesa Sucupira - Acabamento',
  },
  {
    id: 7,
    src: 'https://res.cloudinary.com/dci7rpsws/image/upload/v1758570343/l9podscyisioicbsxgbi_aiicq8.webp',
    alt: 'Mesa Sucupira - Acabamento',
  },
  {
    id: 8,
    src: 'https://res.cloudinary.com/dci7rpsws/image/upload/v1758570338/knaeqqbjbfjjla1pbq8b_r5eym8.webp',
    alt: 'Mesa Sucupira - Acabamento',
  },
  {
    id: 9,
    src: 'https://res.cloudinary.com/dci7rpsws/image/upload/v1758570334/cenutz8qj6ruoh9lb4gt_icw4dq.webp',
    alt: 'Mesa Sucupira - Acabamento',
  },
  {
    id: 10,
    src: 'https://res.cloudinary.com/dci7rpsws/image/upload/v1758570334/buw9upyoxfosnidxxumk_hodcun.webp',
    alt: 'Mesa Sucupira - Acabamento',
  },
]
...
const PRODUCT_INFO: ProductInfo = {
  name: 'Mesa sucupira',
  status: 'sob demanda',
  materials: ['100% Sucupira', 'Mármore'],
  dimensions: [
    { value: '400', unit: 'c' },
    { value: '70', unit: 'h' },
    { value: '90', unit: 'p' },
...
function MobileGallery({ images }: MobileGalleryProps) {
  ...
  const openModal = (index: number): void => {
    setCurrentIndex(index + 1) // +1 porque estamos usando slice(1)
    setIsModalOpen(true)
  }
