...
export default function SubHero() {
  ...
  return (
    ...
    >
      ...
      <div className="mx-3 lg:mx-0 flex lg:gap-5 gap-5 mb-6">
        <h1 className="xl:text-5xl lg:text-4xl md:text-3xl text-xl w-3/4 xl:w-4/5 font-light text-leon-black">
          {t('hero')}
        </h1>
      ...
      <motion.div
        ...
        className="absolute bottom-0 left-0 right-0 h-[1px] bg-leon-black"
      />
    </div>
  )
}
